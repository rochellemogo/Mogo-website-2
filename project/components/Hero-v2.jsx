  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden', marginTop: -80, paddingTop: 80, background: 'var(--m-ink)', color: '#fff' }}>
      ...
      <div className="shell" style={{ position: 'relative', zIndex: 2, padding: '120px 28px 180px' }}>
        ...
        <div style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 'clamp(28px, 3.2vw, 52px)', color: 'rgba(255,255,255,.85)', margin: '18px 0 0', letterSpacing: '-.01em' }}>
          {tagline}
        </div>

        <p style={{ fontSize: 20, lineHeight: 1.5, color: 'rgba(255,255,255,.78)', maxWidth: 620, margin: '36px 0 40px' }}>{body}</p>
